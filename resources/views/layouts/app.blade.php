                ...
                <ul class="mainnav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{ route('retur-penjualan') }}">Retur Penjualan</a></li>
                            <li><a href="{{ route('retur-pembelian') }}">Retur Pembelian</a></li>
                        </ul>
                    </li>                    
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{ route('set_harga_jual.index') }}">Set Harga Jual Barang</a></li>
