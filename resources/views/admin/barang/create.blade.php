                    ...
                    <form action="{{ route('barang.store') }}" method="POST" id="inputbarang" class="form-horizontal">
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" class="span6" name="harga_modal" id="harga_modal" onchange="keuntungan()" required>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" class="span2" name="harga_grosir" id="harga_grosir" readonly>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" class="span2" name="harga_langganan" id="harga_langganan" readonly>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" class="span6" name="harga_umum" id="harga_umum" readonly>
                                </div>
                            </div>
